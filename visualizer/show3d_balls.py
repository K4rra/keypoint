...
import sys
import os
sys.path.append("/mnt/sdb2/work/dr/Projects/profeta/Point-Transformers-master")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--category', type=str, default='teeth', help='select category')
    parser.add_argument('--npoints', type=int, default=1024, help='resample points number')
    parser.add_argument('--ballradius', type=int, default=4, help='ballradius')
    ...
    root = '/mnt/sdb2/work/dr/Projects/profeta/Point-Transformers-master/predictions'
    dataset = PartNormalDataset(root=root, npoints=1024, split='test', normal_channel=False)
