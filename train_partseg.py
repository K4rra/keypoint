...
seg_classes = {'Teeth': [0, 1]}
seg_label_to_cat = {0: "Teeth", 1: "Teeth"}  # {0:Airplane, 1:Airplane, ...49:Table}
...
def main(args):
    ...
    root = hydra.utils.to_absolute_path('/mnt/sdb2/work/dr/Projects/profeta/key_point_segmentation/shapenetcore_partanno_segmentation_benchmark_v0_normal')
